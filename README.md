...
dependencies {
    ...
    implementation("com.github.EugenePonomarev.styled-qr-kmp:qrcode-android-view:0.2.3")

    // Or Jetpack Compose (also brings the Android View adapter):
    implementation("com.github.EugenePonomarev.styled-qr-kmp:qrcode-compose:0.2.3")

    // Encoder, SVG renderer, and Android Bitmap renderer only:
    implementation("com.github.EugenePonomarev.styled-qr-kmp:qrcode-core:0.2.3")
}
```

Use the Git tag shown in GitHub Releases in place of `0.2.3`. JitPack builds a public tag on the
...
2. Commit the change and create a matching Git tag, for example `0.2.3`.
